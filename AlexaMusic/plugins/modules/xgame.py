...
GAME_MESSAGE = "⩹━★⊷━𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب افاتار\n\n⩹━★⊷━𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('★¦العاب افاتار', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥⚡️', url =f"https://t.me/source_av")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥━⊶★━⩺\n\nمرحبا بك في قسم العاب افاتار 3D\n\n⩹━★⊷━𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب افاتار\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب فيجا', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗩𝗔𝗧𝗔𝗥⚡️', url =f"https://t.me/source_av")              
                 ],[
                InlineKeyboardButton(
